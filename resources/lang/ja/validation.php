...
return [
    ...
    */
    ...
    'boolean'              => ':attributeは、いずれかを選択してください。',
    'confirmed'            => '正しく二度入力してください',
    ...
    'regex'                => '使用可能な文字を入力してください',
    'required'             => '必ず入力してください。',
    'required_if'          => ':otherが:valueの場合、:attributeも指定してください。',
    'required_unless'      => ':otherが:valuesでない場合、:attributeを指定してください。',
    'required_with'        => 'ご入力の場合は、両方とも入力してください。',
    ...
    */
    ...
    'attributes' => array_merge(Inquiry::ATTR, User::ATTR, Step::ATTR),
